...
pub(crate) struct DynamicContact {
...
pub(crate) fn solve_dynamic_contact(
    bodies: &mut [PhysicsBody],
    dc: &DynamicContact,
    correction_scale: f32,
    apply_velocity: bool,
...
pub(crate) fn slope_surface_y(body: &PhysicsBody, world_x: f32) -> f32 {
    match body.slope {
...
pub(crate) fn surface_normal_at(body: &PhysicsBody, _world_x: f32) -> (f32, f32) {
    match body.slope {
...
pub(crate) fn rotated_surface_y(plat: &PhysicsBody, world_x: f32) -> f32 {
...
pub(crate) fn penetration_depth(obj: &PhysicsBody, plat: &PhysicsBody, nx: f32, ny: f32) -> f32 {
...
pub(crate) fn resolve_solid_collision(
    obj: &PhysicsBody,
    plat: &PhysicsBody,
) -> Option<(f32, f32, u8)> {
